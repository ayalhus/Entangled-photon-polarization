...
public class EntangledPhotonMeasurement 
{
    ...
    public void performMeasurement()
    {
        ...
        if(rand<prob00)
        {
            ...
            System.out.print("After measurement, the photon angles are "+formatNumber(angle1)+" and "+formatNumber(angle2));
            System.out.println(" and the photon state is "+formatNumber(p00)+" "+formatNumber(p01)+" "+formatNumber(p10)+" "+formatNumber(p11));
        }
